		   ...
		   <div class="container-fluid">
		        <div class="row">
		            <div class="col-12 col-sm-6 col-md-6">
		                <h3 class="text-dark mb-4">관리자페이지</h3>
		            </div>
		        </div>
		            ...
		            <div class="card-header py-3">
		                <div class="row table-topper align-items-center">
		                    <div class="col-12 col-sm-5 col-md-6 text-start" style="margin: 0px;padding: 5px 15px;">
		                        <p class="text-primary m-0 fw-bold">주문 승인</p>
		                    </div>
		                    <div class="col-12 col-sm-7 col-md-6 text-end" style="margin: 0px;padding: 5px 15px;"><input type="text"><button class="btn btn-primary btn-sm reset" type="button" style="margin: 2px;">주문검색</button></div>
		                </div>
		            </div>
		            <div class="row">
		                <div class="col-12">
		                    <div class="table-responsive">
		                        <table class="table table-striped table tablesorter" id="ipi-table">
		                            ...
		                            <tbody class="text-center">
			                            <c:choose>
			                            	<c:when test="${fn:length(admin.pResult) > 0}">
			                            		<c:forEach var="i" items="${admin.pResult}" begin="0" end="${fn:length(admin.pResult)}" step="1" varStatus="status" >
					                                <tr>
					                                    <td>${i.no}</td>
					                                    <td>${i.payment_check}</td>
		    ...
		    <div class="container-fluid">
		        <div class="card" id="TableSorterCard-1">
		            <div class="card-header py-3">
		                <div class="row table-topper align-items-center">
		                    <div class="col-12 col-sm-5 col-md-6 text-start" style="margin: 0px;padding: 5px 15px;">
		                        <p class="text-primary m-0 fw-bold">회원 탈퇴</p>
		                    </div>
		                    <div class="col-12 col-sm-7 col-md-6 text-end" style="margin: 0px;padding: 5px 15px;"><input type="text"><button class="btn btn-primary btn-sm reset" type="button" style="margin: 2px;">회원검색</button></div>
		                </div>
		            </div>
		            <div class="row">
		                <div class="col-12">
		                    <div class="table-responsive">
		                        <table class="table table-striped table tablesorter" id="ipi-table">
		                            ...
		                            <tbody class="text-center">
			                            <c:choose>
			                            	<c:when test="${fn:length(admin.mResult) > 0}">
			                            		<c:forEach var="i" items="${admin.mResult}" begin="0" end="${fn:length(admin.mResult)}" step="1" varStatus="status" >
					                                <tr>
					                                    <td>${i.id}</td>
					                                    <td>${i.phone}</td>
					                                    <td>${i.email}</td>

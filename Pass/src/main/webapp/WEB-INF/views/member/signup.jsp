	...
	<body>
	        ...
	        <div class="container"><a class="navbar-brand d-flex align-items-center" href="/pass"><span class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center me-2 bs-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-bezier">
	            ...
	            <div class="collapse navbar-collapse" id="navcol-2">
	                <ul class="navbar-nav ms-auto">
	                    ...
	                    <li class="nav-item"><a class="nav-link" href="#"><span style="color: rgb(32, 33, 36);">마이페이지</span></a></li>
	                </ul><a class="btn btn-primary ms-md-2" role="button" href="/pass/member/login">Login</a>
	            </div>
	        </div>
	    </nav>
	    <form action="/action_page.php">
	        <div class="gc004-container">
	            ...
	            <hr><label class="form-label fw-bold" for="id">ID</label><input type="text" placeholder="Enter ID" name="id" required="">
	            <label class="form-label fw-bold" for="psw">Password</label><input type="password" placeholder="Enter Password" name="pass" required="">
	            <label class="form-label fw-bold" for="psw">Repeat Password</label><input type="password" placeholder="Repeat Password" name="psw-repeat" required="">
	            <label class="form-label fw-bold" for="phone">Phone</label><input class="form-control" type="text" placeholder="Enter Phone" name="phone" required="">
	            <label class="form-label fw-bold" for="email">Email</label><input type="text" placeholder="Enter Email" name="email" required="">
	            <label class="form-label fw-bold" for="zipcode">Zipcode</label><input type="text" placeholder="Enter Zipcode" name="zipcode" required="">
	            <label class="form-label fw-bold" for="address">Address</label><input type="text" placeholder="Enter Address" name="address" required="">
	            <label class="form-label fw-bold" for="id">Building</label><input type="text" placeholder="Enter Building" name="building" required="">
